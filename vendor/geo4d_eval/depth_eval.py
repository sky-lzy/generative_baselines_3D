...
## Vendored verbatim from Geo4D/dust3r/depth_eval.py.
## The dust3r-coupled wrappers (eval_mono_depth_estimation / eval_mono_depth)
## are dropped here; only the metric helpers (depth2disparity, scaling, and
## depth_evaluation) are kept. Do NOT modify — this is the reference code.
